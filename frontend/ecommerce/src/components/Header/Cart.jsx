...
function Cart(){
    return (
        <>
            <div className="icon">
                <a className="img_hover_cart" href="/checkout/cart" title="Giỏ hàng">
                    <svg height="25" width="25" enable-background="new 0 0 407.453 407.453" version="1.1" viewBox="0 0 407.45 407.45" xmlns="http://www.w3.org/2000/svg">
                    <g fill="#010002" >
                    ...
                    <span className={styles["counter-item"]}>0</span>
                </a>
            </div>
        </>
    )
